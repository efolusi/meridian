...
- The target is Indonesian and English as first-class: the docs available in both, and locale-aware behaviour where it actually matters (Calendar, DatePicker and NumberInput formatting and parsing). Both halves have shipped; what remains is depth, not foundations.
