...
Starter twin: `starters/auth-page/` is the copyable multi-page journey for this category; this kit shows the screens as liftable plain JSX. When a screen changes in one, update the other.
