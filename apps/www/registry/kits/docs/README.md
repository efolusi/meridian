...
Starter twin: `templates/docs-page/` is the copyable multi-page journey for this category; this kit shows the layout as liftable plain JSX. When the layout changes in one, update the other.
