...
- Full screens to copy from: `ui_kits/{console,auth,website,docs,agent,infra,trader,tools}/`; page-shell template in `templates/app-page/`.
...
- Templates for new pages: `templates/{dashboard,auth-page,marketing-page,docs-page,app-page}/`.
