...
{ label: 'Products', items: [{ id: 'agent', label: 'AI agents', icon: 'bot' }] },
  ...
  footer={<Item size="sm"><ItemMedia><Avatar name="Ada Obi" size={30} /></ItemMedia><ItemContent><ItemTitle>Ada Obi</ItemTitle><ItemDescription>Acme Workspace</ItemDescription></ItemContent></Item>} />
```
