...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
const CSS = `
.ef-listitem{display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:var(--radius-sm);text-align:start;width:100%;border:none;background:none;font-family:var(--font-sans);color:var(--text-primary)}
...
.ef-listitem__trailing{margin-inline-start:auto;flex:none;display:inline-flex;align-items:center;gap:8px;color:var(--text-muted)}
`;
function ListItem({
  icon,
  media,
