...
function Avatar({
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    className: `ef-avatar${className ? ' ' + className : ''}`,
    title: name || undefined,
    style: {
      width: size,
      height: size,
      fontSize: Math.round(size * 0.38),
      background: showImg ? 'var(--sand-100)' : bg,
      color: fg,
      ...style
    }
