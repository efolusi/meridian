...
- **Browser support matrix + RTL statement.** DirectionProvider and mirrored keyboard behavior for Tabs, Menubar, DigitEntry, Calendar and Resizable landed in 1.x. Still open: migrate remaining physical CSS properties, review mirrored screens, and test the last 2 versions of evergreen browsers before claiming full RTL support.
