...
`;
export function Spinner({ size = 16, label, style, className }) {
  injectEfCss('ef-css-spinner', CSS);
  return (
    <span role="status" aria-label={label || 'Loading'} style={{ display: 'inline-flex', alignItems: 'center', gap: 8, ...style }} className={className}>
