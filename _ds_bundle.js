...
function ChatMessage({
  ...
  }) : null), actions !== false && role === 'assistant' && !streaming ? /*#__PURE__*/React.createElement("div", {
...
.ef-toast-stack{position:fixed;bottom:24px;right:24px;display:flex;flex-direction:column;gap:10px;z-index:110}
...
function TraderScreen() {
  ...
  }, "Momentum \\u00b7 EUR pairs \\u00b7 max 3 open positions. Every trade is logged and auditable."), /*#__PURE__*/React.createElement(Slider, {
...
function BrandBand() {
  ...
  }, "\u201CWe deleted 40k lines of billing code the week we adopted Ledger. I'm still a little emotional about it.\u201D"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center',
