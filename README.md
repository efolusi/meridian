...
[![Components](https://img.shields.io/badge/components-121-A0693C.svg)](https://meridian.efolusi.com/site/Components.dc.html)
...
- `components/feedback/` — Dialog, ConfirmDialog, Sonner (`Toaster` + `toast`), Tooltip, Alert, Banner, Progress, Spinner, Loader
...
- `components/<group>/` — the 121 components; each ships `.jsx` + `.d.ts` + `.prompt.md` + a group card HTML
