...
function Table({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    key: key(row, i),
    className: onRowClick ? 'ef-table__row--click' : '',
...
function Tooltip({
  ...
  return /*#__PURE__*/React.createElement("span", {
    className: `ef-tooltip${position === 'bottom' ? ' ef-tooltip--bottom' : ''}${className ? ' ' + className : ''}`,
    style: style,
    onKeyDown: e => {
...
function Select({
  ...
  const control = /*#__PURE__*/React.createElement("span", {
    className: `ef-select ef-select--${size}${invalid ? ' ef-select--invalid' : ''}`
...
function useAnchoredStyle(anchorRef, panelRef, {
  ...
  React.useLayoutEffect(() => {
    if (!open) {
      setStyle(s => s.visibility === 'hidden' ? s : {
        ...s,
        visibility: 'hidden'
      });
      return;
...
function ModelSelector({
  ...
  const ref = React.useRef(null);
  const panelRef = React.useRef(null);
  const anchored = __ds_scope.useAnchoredStyle(ref, panelRef, {
    open,
...
function AgentScreen() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    groups: CMD_GROUPS
  }), /*#__PURE__*/React.createElement(ToastStack, null, toast && /*#__PURE__*/React.createElement(Toast, {
    tone: "success",
    title: toast.title,
...
function MembersTab({
  ...
  return /*#__PURE__*/React.createElement(Card, {
    padding: 0,
    title: "Members",
    subtitle: "3 of 5 seats used on the Growth plan.",
    actions: /*#__PURE__*/React.createElement(Button, {
      size: "sm",
      iconLeft: "plus",
...
function ApiTab({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    footer: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Button, {
      ...
      onClick: () => {
        setConfirm(false);
        notify('Deletion requested', 'Owners get a confirmation email first.');
      }
    }, "Delete forever"))
  }, /*#__PURE__*/React.createElement(Input, {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    actions: /*#__PURE__*/React.createElement(Switch, {
      ...
      onChange: e => {
        ...
        notify(e.target.checked ? 'Robot resumed' : 'Robot paused');
      }
    })
  }, /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    onClick: () => follow(n)
  }, followed.includes(n) ? 'Mirroring' : 'Mirror')))))))), /*#__PURE__*/React.createElement(ToastStack, null, toast && /*#__PURE__*/React.createElement(Toast, {
    tone: "success",
    title: toast,
