...
function Resizable({
  ...
  const key = e => {
    const d = {
      ArrowLeft: readingDirection === 'rtl' ? 0.02 : -0.02,
      ArrowRight: readingDirection === 'rtl' ? -0.02 : 0.02,
      ArrowUp: -0.02,
      ArrowDown: 0.02
    }[e.key];
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    ...
    style: {
      flexBasis: __ds_scope.cssPct(ratio * 100),
      flexGrow: 0,
      flexShrink: 0
    }
