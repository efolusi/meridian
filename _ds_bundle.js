...
function Carousel({
  ...
  const goTo = i => {
    const el = track.current;
    if (el) el.scrollTo({
      left: (direction === 'rtl' ? -1 : 1) * i * step(),
      behavior: __ds_scope.prefersReducedMotion() ? 'auto' : 'smooth'
    });
  };
  const onScroll = () => {
    const el = track.current;
    if (el) setIndex(Math.min(count - 1, Math.max(0, Math.round(Math.abs(el.scrollLeft) / step()))));
  };
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "region",
    ...
    className: "ef-carousel__item"
  }, c))), showControls ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
    type: "button",
    "aria-label": "Previous",
    disabled: index <= 0,
    className: "ef-carousel__nav ef-carousel__nav--prev",
    ...
    className: "ef-carousel__nav ef-carousel__nav--next",
    onClick: () => goTo(index + 1)
  }, /*#__PURE__*/React.createElement(__ds_scope.Icon, {
    name: direction === 'rtl' ? 'chevron-left' : 'chevron-right',
    size: 16
  }))) : null, showDots ? /*#__PURE__*/React.createElement("div", {
    className: "ef-carousel__dots"
  }, Array.from({
    length: count
    ...
    className: `ef-carousel__dot${i === index ? ' ef-carousel__dot--on' : ''}`,
    onClick: () => goTo(i)
  }))) : null);
}
...
const Select = React.forwardRef(function Select({
  ...
  if (!label && !hint) return React.cloneElement(control, {
    style,
    className: control.props.className + (className ? ' ' + className : '')
  });
  return /*#__PURE__*/React.createElement("label", {
...
const NativeSelect = React.forwardRef(function NativeSelect({
  ...
  return /*#__PURE__*/React.createElement(__ds_scope.Select, _extends({}, props, {
    ref: ref
  }), children);
});
...
function CustomersScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    size: "sm",
    options: ['All plans', 'Starter', 'Growth', 'Scale'],
    value: plan,
...
function InfraScreen() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    label: "Kind",
    options: ['PostgreSQL', 'MySQL', 'Redis', 'SSH host', 'Kubernetes', 'AWS account', 'Domain / DNS']
  }), /*#__PURE__*/React.createElement(Input, {
    label: "Host",
    ...
    label: "Region",
    options: ['eu-west-1', 'us-east-1', 'fra1', 'sgp1']
  }))), /*#__PURE__*/React.createElement(Drawer, {
    open: cli,
...
function ToolsScreen() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    label: "Convert to",
    options: ['DOCX', 'PDF', 'PNG', 'WEBM', 'MP3', 'TXT'],
    value: format,
...
__ds_ns.DigitEntry = __ds_scope.DigitEntry;
