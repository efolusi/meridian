...
const NAV = [
  ...
  ['AI agents', [['tasks', 'Running tasks'], ['tools', 'Tool use']]],
  ['Infrastructure', [['connections', 'Connections'], ['dns', 'Domains & DNS']]],
  ['Automation', [['nodes', 'Automation nodes'], ['media', 'Media pipelines']]],
  ['File tools', [['convert', 'Converting files']]],
  ['Trading', [['strategies', 'Strategies'], ['risk', 'Risk limits']]],
];
