...
for (const helper of ['badgeVariants', 'buttonVariants', 'markerVariants', 'navigationMenuTriggerStyle', 'toggleVariants', 'useMessageScroller', 'useMessageScrollerScrollable', 'useMessageScrollerVisibility']) {
