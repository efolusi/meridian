...
**Baseline today:** 123 components (source + `.d.ts` + `.prompt.md`), 167 unique token names in light/dark/compact, 118 icons, 12 blocks, 8 example apps, 9 starter journeys, docs site with live demos and search, guidelines (accessibility, forms, governance), MIT license, llms.txt + agent skill.
