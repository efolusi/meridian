...
**A general-purpose open-source design system by [Efolusi](https://efolusi.com).** 105 accessible React components, 177 design tokens in light, dark and compact, 9 blocks, and 8 full example apps — served browser-native with **no build step**.
...
- `components/<group>/` — the 105 components; each ships `.jsx` + `.d.ts` + `.prompt.md` + a group card HTML
