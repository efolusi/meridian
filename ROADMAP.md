...
**Baseline today:** 104 components (source + `.d.ts` + `.prompt.md`), 172 tokens in light/dark/compact, 108 icons, 9 blocks, 8 example apps, 5 starter journeys, docs site with live demos and search, smoke page (121 demos), guidelines (accessibility, forms, governance), MIT license, llms.txt + agent skill.
