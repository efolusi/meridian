...
**A general-purpose open-source design system by [Efolusi](https://efolusi.com).** 122 accessible React components, 165 design tokens in light, dark and compact, 12 blocks, and 8 full example apps — served browser-native with **no build step**.
