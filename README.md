...
**A general-purpose open-source design system by [Efolusi](https://efolusi.com).** 109 accessible React components, 177 design tokens in light, dark and compact, 9 blocks, and 8 full example apps — served browser-native with **no build step**.
...
- `assets/` — logo.png, fonts/ (5 variable WOFF2 + OFL license texts), icons/ (115 SVGs: 113 Lucide + 2 brand marks, + license)
