...
Shared sign-in / create-account screens for a multi-app workspace. Split layout: brand panel (espresso, Meridian mark, workspace pitch + trust badges) + form panel. Interactive: toggle between sign in and sign up, password reveal, fake submit with loading → success.
