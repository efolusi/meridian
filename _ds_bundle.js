...
function Badge({
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    className: `ef-badge ef-badge--${tone}${size === 'md' ? ' ef-badge--md' : ''}${className ? ' ' + className : ''}`,
    style: style
