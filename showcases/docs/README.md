...
A documentation site: top bar with search, left nav tree, article with code blocks + callout, right table of contents. Interactive: sidebar switches between articles, copy buttons on code.
