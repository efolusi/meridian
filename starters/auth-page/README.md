...
Showcase twin: `showcases/auth/` covers the same category as plain JSX screens you can lift into a React app. When a screen changes in one, update the other.
