...
**A general-purpose open-source design system by [Efolusi](https://efolusi.com).** 122 accessible React components, 167 design tokens in light, dark and compact, 12 blocks, and 8 full example apps — served browser-native with **no build step**.
...
- `packages/` — source workspaces for the standalone public tokens, icons, and Meridian Guard packages; publishable output is generated under each `dist/`
