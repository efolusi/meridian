...
**Baseline today:** 121 components (source + `.d.ts` + `.prompt.md`), 165 unique token names in light/dark/compact, 118 icons, 9 blocks, 8 example apps, 9 starter journeys, docs site with live demos and search, guidelines (accessibility, forms, governance), MIT license, llms.txt + agent skill.
