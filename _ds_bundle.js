...
.ef-hovercard__panel{position:absolute;inset-inline-start:0;background:var(--surface-card);border:1px solid var(--border-strong);border-radius:var(--radius-md);box-shadow:var(--shadow-md);padding:14px;z-index:var(--z-popover);animation:ef-hovercard-in var(--dur-med) var(--ease-out)}
...
function HoverCard({
  ...
  }, trigger), open ? /*#__PURE__*/React.createElement(__ds_scope.Portal, null, /*#__PURE__*/React.createElement("div", {
    ref: panelRef,
    onMouseEnter: enter,
    onMouseLeave: leave,
