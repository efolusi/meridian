...
### Install source with the shadcn CLI

Meridian is also a public GitHub Registry. Install editable component source,
types, usage guidance, and required Meridian dependencies directly into a
project:

```bash
npx shadcn@latest add efolusi/meridian/button
npx shadcn@latest add efolusi/meridian/starter-service-desk
```

Inspect an item before installing it with
`npx shadcn@latest view efolusi/meridian/button`. The same catalog remains
available over HTTP at `https://meridian.efolusi.com/site/registry.json`.
...
- `registry.json` — source registry for `shadcn add efolusi/meridian/<item>`
