...
Starter twin: `starters/marketing-page/` is the copyable multi-page journey for this category; this example app shows the sections as liftable plain JSX. When a section changes in one, update the other.
