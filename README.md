...
**A general-purpose open-source design system by [Efolusi](https://efolusi.com).** 110 accessible React components, 166 design tokens in light, dark and compact, 9 blocks, and 8 full example apps — served browser-native with **no build step**.
