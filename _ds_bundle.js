...
function Input({
  ...
  const control = /*#__PURE__*/React.createElement("span", {
    className: `ef-input ef-input--${size}${iconLeft ? ' ef-input--icon' : ''}${showToggle ? ' ef-input--reveal' : ''}${bad ? ' ef-input--invalid' : ''}`
